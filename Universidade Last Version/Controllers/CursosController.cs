    ...
    public class CursosController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Cursos != null ? 
                          ...
                          Problem("Entity set 'EscolaContexto.Cursos'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Titulo,Creditos")] Curso curso)
        {
            try
            {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EscolaContexto.Cursos'  is null.");
            }
            var curso = await _context.Cursos.FindAsync(id);
            if (curso != null)
            {
